...
pub unsafe trait DataSource<'v>: Sized {
    ...
    fn apply_sources(buffers: Self::Buffers, vao: &mut Binder<'v>);
}
...
unsafe impl<'v> DataSource<'v> for Nil {
    ...
    fn apply_sources(_buffers: Self::Buffers, _binder: &mut Binder<'v>) {}
}
    ...
    L: DataSource<'v>,
{
    ...
    fn apply_sources(buffers: Self::Buffers, binder: &mut Binder<'v>) {
        binder.bind_buffer(buffers.0);
        L::apply_sources(buffers.1, binder);
    }
}
